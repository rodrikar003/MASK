...
Car.prototype.update = function () {
    ...
    } else if (this.game.a && this.speed > 0) {
        this.angle -= 5;
        this.right = true;
    } else if (this.game.w) {
    ...
    if (this.y > 911) {
        this.currentTile.src = "./img/4.jpg";
        this.tile = 4;
    } else {
        this.currentTile.src = "./img/5.jpg";
        this.tile = 5;
...
ASSET_MANAGER.queueDownload("./img/4.jpg");
ASSET_MANAGER.queueDownload("./img/carRight.png");
...
ASSET_MANAGER.downloadAll(function () {
    ...
    gameEngine.addEntity(new Background(gameEngine, ASSET_MANAGER.getAsset("./img/4.jpg"), 0, 911));
